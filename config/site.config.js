...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'Kunal@xwb7q.onmicrosoft.com',
  ...
  email: 'mailto:Kunal@xwb7q.onmicrosoft.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Helpless69/onedrive-vercel-index',
    },
  ],
